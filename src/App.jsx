...
import Unauthorized from "./landing-page-and-auth/Unauthorized";
      ...
      <Routes>
        ...
        <Route element={<RequireAuth />}>
          ...
          <Route
            ...
            element={<DashboardCompletedCourses />}
          />
          <Route
            path="/ongoing-courses"
            element={<DashboardOngoingCourses />}
          />
          <Route path="/dashboard-courses/:slug" element={<EnrollCourses />} />

          <Route path="/dashboard-home/:slug" element={<CourseModules />} />
          <Route
            path="/dashboard-home/:slug/:slug"
            element={<CourseLessons />}
          />
          <Route
            path="/dashboard-home/:slug/:slug/:slug"
            element={<CourseLessonContent />}
          />

          <Route
            path="/dashboard-find-partners"
            element={<DashboardFindPartners />}
          />
          <Route path="/dashboard-chats" element={<DashboardChats />} />
          <Route
            path="/dashboard-chats/chat-interface/:slug"
          ...
          <Route
            ...
            element={<ProfileUpdateDetails />}
          />
          <Route
            path="/profile-picture-update"
            element={<ProfilePictureUpdate />}
          />
          ...
          />
          <Route
            path="/profile-change-email-verification"
            element={<ProfileChangeEmailVerification />}
          />

          <Route path="/dashboard-blog" element={<DashboardBlogs />} />
          <Route
            path="/dashboard-blog/:slug"
            element={<DashboardBlogContent />}
          />
          ...
          />
          <Route
            path="/dashboard/subscription-plans/subscribe"
            element={<MPESAPayment />}
          />
          <Route
            path="/dashboard/mpesa-payment"
            element={<MPESAPaymentRedirect />}
          />
        </Route>
