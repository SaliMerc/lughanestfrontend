...
function ChatInterface() {
    ...
    const [isTyping, setIsTyping] = useState(false); // partner typing state
    const [amTyping, setAmTyping] = useState(false); // my typing state
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-row !bg-[var(--form-card-bg)] rounded-xl shadow-md px-3 py-2">
                            <div className='flex flex-row justify-between items-center w-full'>
                                ...
                                <div onClick={handleSubmit}>
                                    <FontAwesomeIcon icon={faPaperPlane} className="text-white text-lg cursor-pointer ml-10" />
                                </div>
                            </div>
                        </form>
                    ) : (
