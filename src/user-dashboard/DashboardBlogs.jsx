...
function DashboardBlogs() {
    ...
    return (
        <DashboardNavigation>
            ...
            <div className='text-white min-h-screen md:pt-5'>
                <section className=''>
                    ...
                    <div className='flex md:flex-wrap flex-col md:flex-row justify-center gap-8 items-center py-5'>
                        {loading ? (
                            ...
                            blogItems.map((blog, index) => (
                                <div key={index} className='min-h-[250px] w-full sm:w-[45%] md:w-[30%] bg-[#0E0D0C] flex flex-col justify-center items-center text-center gap-10 rounded-[20px] p-4 md:p-6'>
